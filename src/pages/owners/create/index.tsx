...
function OwnerCreatePage() {
  ...
  const formik = useFormik<OwnerInterface>({
    initialValues: {
      company_name: '',
      establishment_date: new Date(new Date().toDateString()),
    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="establishment_date" mb="4">
            <FormLabel fontSize="1rem" fontWeight={600}>
              Establishment Date
            </FormLabel>
            <DatePicker
              selected={formik.values?.establishment_date ? new Date(formik.values?.establishment_date) : null}
              onChange={(value: Date) => formik.setFieldValue('establishment_date', value)}
            />
          </FormControl>
